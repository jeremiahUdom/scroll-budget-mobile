...
const Auth = () => {
  ...
  const handleCreateAccount = async () => {
    ...
    try {
      ...
      // signup user
      const result = await signup({email: validation.data.email, password: validation.data.password})
      ...
      setCreateAccountError("An error occured while creating your account. Please try again")
      setShowError(true)
      return
    } finally {
      setLoading(false)
  ...
  return (
    <SafeAreaView style={styles.main}>
      ...
      <View style={styles.view}>
        ...
        <Text style={styles.body}>Already have an account? <Link style={styles.link} href={"/(auth)/Login"}>Login</Link></Text>
      </View>
      ...
      <MessageModal
        ...
        onCloseModal={() => {
          router.replace("/(onboarding)/SetDailyBudget")
          setMessage("")
